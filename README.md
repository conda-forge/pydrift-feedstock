About pydrift-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pydrift-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9911&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pydrift-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pydrift` can be installed with `conda`:
...
```
mamba install pydrift
```

It is possible to list all of the versions of `pydrift` available on your platform with `conda`:
...
```
mamba search pydrift --channel conda-forge
```
...
mamba repoquery search pydrift --channel conda-forge

# List packages depending on `pydrift`:
mamba repoquery whoneeds pydrift --channel conda-forge

# List dependencies of `pydrift`:
mamba repoquery depends pydrift --channel conda-forge
```
